...
/**
 * A JVM implementation of [SnapshotStore] that saves snapshots to files on the local filesystem
 * using `okio` for cross-platform file operations and `dataforge-io` for serialization.
 *
