...
@SerialName("detach")
@Serializable(with = DetachActionSpec.Serializer::class)
public class DetachActionSpec : Scheme(), PlanActionSpec {
    ...
    public companion object : SchemeSpec<DetachActionSpec>(::DetachActionSpec)
    public object Serializer : SchemeAsMetaSerializer<DetachActionSpec>(Companion)
}
