 ...
 * structure of a [space.kscience.controls.composite.model.contracts.logic.ActionHandler]. It provides a mechanism for creating type-safe references ([MetaRef])
