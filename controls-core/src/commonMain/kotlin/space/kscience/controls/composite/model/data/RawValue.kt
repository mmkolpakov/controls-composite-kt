package space.kscience.controls.composite.model.data
 ...
 *
 * It strictly corresponds to the [space.kscience.controls.composite.model.common.DataType] enumeration.
 */
@Serializable
public sealed interface RawValue {
     ...
     * Corresponds to [space.kscience.controls.composite.model.common.DataType.BINARY].
     */
    @Serializable
     ...
     * Corresponds to [space.kscience.controls.composite.model.common.DataType.DOUBLE_ARRAY].
     */
    @Serializable
     ...
     * Corresponds to [space.kscience.controls.composite.model.common.DataType.INT_ARRAY].
     */
    @Serializable
     ...
     * Corresponds to [space.kscience.controls.composite.model.common.DataType.BYTE_ARRAY].
     ...
     * Corresponds to [space.kscience.controls.composite.model.common.DataType.RECORD].
