 ...
 * These events correspond to commands issued by a DeviceHub.
 *
 * Note: These are pure DTOs and do not implement any library-specific Event interface
 * to avoid dependencies in the Core module.
 */
