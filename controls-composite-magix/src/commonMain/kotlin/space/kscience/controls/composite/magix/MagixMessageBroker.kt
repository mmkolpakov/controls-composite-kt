...
import space.kscience.controls.composite.model.contracts.MessageBroker
 ...
 * It translates the broker's topic-based publish/subscribe model to Magix's source/target endpoint model.
 *
