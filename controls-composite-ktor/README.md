# Module controls-composite-ktor

**Maturity**: PROTOTYPE

## Description

This module provides multiplatform implementations of the `Port` and `PeerConnection` contracts from `controls-composite-model` and `controls-composite-ports` using the Ktor networking library. It serves as a foundational transport layer for building device drivers that communicate over TCP or UDP.
