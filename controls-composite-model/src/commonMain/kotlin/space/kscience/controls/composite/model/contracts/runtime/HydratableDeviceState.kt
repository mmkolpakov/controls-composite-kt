 ...
 * "Hydration" is the process of creating the actual, live [space.kscience.controls.composite.model.state.DeviceState] using the context
...
public fun interface HydratableDeviceState<in D : Device, out T> {
    /**
     * Creates the live [space.kscience.controls.composite.model.state.DeviceState] using the provided device instance as context.
     * This method is called by the runtime during device initialization.
     *
     * @param device The device instance that owns this state.
     * @return The fully initialized, reactive [space.kscience.controls.composite.model.state.DeviceState].
     */
