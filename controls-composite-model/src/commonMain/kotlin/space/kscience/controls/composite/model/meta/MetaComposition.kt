 ...
 *
 * @param blueprintMeta The base metadata from the [space.kscience.controls.composite.model.contracts.DeviceBlueprint].
 * @param childMeta Optional metadata from a [space.kscience.controls.composite.model.LocalChildComponentConfig].
