 ...
 *
 * This contract is defined in the model to allow blueprints to declare their capability
 * (via [space.kscience.controls.composite.model.features.BinaryDataFeature]) to use it. The actual implementation
