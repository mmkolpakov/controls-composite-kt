...
This module provides a powerful, type-safe, and declarative Domain-Specific Language (DSL) for constructing `DeviceBlueprint` instances. It acts as a "builder" layer on top of the pure `controls-model`, allowing developers to define complex devices in an intuitive and readable way.
