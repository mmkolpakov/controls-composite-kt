 ...
 */
@PublishedApi
internal fun <D : Device, T> DeviceSpecification<D>.internalLogicalProperty(
 ...
 */
public inline fun <D : Device, reified T> DeviceSpecification<D>.logicalProperty(
    converter: MetaConverter<T>,
    noinline descriptorBuilder: PropertyDescriptorBuilder.() -> Unit = {},
    name: Name? = null,
    noinline read: suspend D.() -> T?,
): ReadOnlyProperty<DeviceSpecification<D>, PropertyDelegateProvider<Any?, ReadOnlyProperty<CompositeDeviceContext, DeviceState<T>>>> =
    internalLogicalProperty(converter, typeOf<T>(), descriptorBuilder, name, read)
