...
import space.kscience.controls.composite.model.contracts.logic.DeviceDriver
import kotlin.time.Duration

/**
 * Provides a type-safe context for defining the lifecycle FSM within a [ExecutableDeviceBlueprint].
...
public interface LifecycleContext<D : Device> {
     ...
     */
    public suspend fun <CD : Device> child(blueprint: ExecutableDeviceBlueprint<CD>): CD
