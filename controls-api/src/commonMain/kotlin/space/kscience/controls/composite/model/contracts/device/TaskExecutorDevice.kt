 ...
 * A [space.kscience.controls.composite.model.contracts.logic.ExecutableDeviceBlueprint] must declare the [space.kscience.controls.composite.model.features.TaskExecutorFeature]
...
public interface TaskExecutorDevice : Device {
    ...
    public companion object {
         ...
         */
        public const val CAPABILITY: String = "space.kscience.controls.composite.model.contracts.device.TaskExecutorDevice"
    }
     ...
     * @throws space.kscience.controls.composite.model.specs.faults.DeviceActionException if the task is not supported or fails.
     */
