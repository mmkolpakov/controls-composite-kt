 ...
 * without a full restart. A [space.kscience.controls.composite.model.contracts.logic.ExecutableDeviceBlueprint] must declare this capability for it to be used.
 */
public interface ReconfigurableDevice : Device {
    ...
    public companion object {
         ...
         */
        public const val CAPABILITY: String = "space.kscience.controls.composite.model.contracts.device.ReconfigurableDevice"
    }
