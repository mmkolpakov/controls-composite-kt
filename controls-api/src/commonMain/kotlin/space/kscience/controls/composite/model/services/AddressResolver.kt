...
import space.kscience.controls.composite.model.contracts.communication.TransportAddress
...
public interface AddressResolver : Plugin {
     ...
     */
    public suspend fun resolve(hubId: Name, context: ExecutionContext): TransportAddress?
