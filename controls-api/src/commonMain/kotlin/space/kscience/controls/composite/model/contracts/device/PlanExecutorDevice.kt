 ...
 * This contract formalizes the ability of a device to orchestrate complex, multistep operations.
 *
 * A [space.kscience.controls.composite.model.contracts.logic.ExecutableDeviceBlueprint] must declare the [space.kscience.controls.composite.model.features.PlanExecutorFeature]
...
public interface PlanExecutorDevice : Device {
    ...
    public companion object {
         ...
         */
        public const val CAPABILITY: String = "space.kscience.controls.composite.model.contracts.device.PlanExecutorDevice"
    }
     ...
     * @throws space.kscience.controls.composite.model.specs.faults.DeviceActionException if the plan execution fails.
     */
