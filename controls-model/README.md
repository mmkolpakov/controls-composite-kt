...
- **State Primitives**: Defines the reactive `DeviceState` and `MutableDeviceState` interfaces, which are the fundamental building blocks for device properties in the `controls-dsl` module.
- **Streaming Contracts**:
