...
public interface CompositeDeviceHub {
     ...
     * `dataforge-data` old. The structure of this tree mirrors the device hierarchy, and it emits
     ...
     * @throws space.kscience.controls.composite.old.CompositeHubTransactionException if the attachment process fails.
     */
     ...
     * @throws space.kscience.controls.composite.old.CompositeHubTransactionException if the detachment process fails.
     */
     ...
     * @param context The [ExecutionContext] for this operation.
     * @throws space.kscience.controls.composite.old.CompositeHubTransactionException if the startup process fails.
     */
     ...
     * @param context The [ExecutionContext] for this operation.
     * @throws space.kscience.controls.composite.old.CompositeHubTransactionException if the stopping process fails.
     */
     ...
     * @throws space.kscience.controls.composite.old.DeviceNotFoundInCompositeHubException if the device does not exist.
     * @throws space.kscience.controls.composite.old.DevicePropertyException if the read operation fails.
     */
     ...
     * @param context The [ExecutionContext] for this operation.
     * @throws space.kscience.controls.composite.old.DeviceNotFoundInCompositeHubException if the device does not exist.
     * @throws space.kscience.controls.composite.old.DevicePropertyException if the write operation fails.
     */
     ...
     * @throws space.kscience.controls.composite.old.DeviceNotFoundInCompositeHubException if the device does not exist.
     * @throws space.kscience.controls.composite.old.DeviceActionException if the action execution fails.
     */
     ...
     * @param context The [ExecutionContext] for this operation.
     * @throws space.kscience.controls.composite.old.CompositeHubTransactionException if reconfiguration fails.
     */
     ...
     * @param context The [ExecutionContext] for this operation.
     * @throws space.kscience.controls.composite.old.CompositeHubTransactionException if the hot swap fails at any stage.
     */
